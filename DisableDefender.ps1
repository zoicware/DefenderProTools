...
$webThreat = (Get-Service | Where-Object { $_.DisplayName -like 'webthreatdefusersvc_*' }).DisplayName
$scriptContent = @"
...
Reg add "HKLM\SYSTEM\ControlSet001\Services\$webThreat" /v "Start" /t REG_DWORD /d "4" /f
